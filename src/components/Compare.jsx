const rows = [
  ...
  ['Готовые промпты', '50+', '100+', '100+'],
  ['Технический пак (карты, eSIM, доступ)', 'check', 'check', 'check'],
  ['Закрытый чат', 'check', 'check', 'VIP-чат'],
  ['Модули 5–7 (монетизация)', 'cross', 'check', 'check'],
  ['Шаблоны для фриланса', 'cross', 'check', 'check'],
  ['Групповые созвоны', 'cross', '4 раза', 'Еженедельно'],
  ['Code review домашек', 'cross', '3 задания', 'Без лимита'],
  ...
  ['Обновления курса навсегда', 'check', 'check', 'check'],
]
